namespace _9._3
{
    ...
    {
        // ta funkcja jest zrobiona z pomoca ai bo nie wiedzialem jak wogle zaczac 
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < Numb; i++)
            {
                ...
                int[] aktualnyZestaw = new int[6];

                for (int j = 0; j < 6; j++)
                {
                    Console.Write(Tab[i, j] + " ");
                    aktualnyZestaw[j] = Tab[i, j];
                }
                Console.WriteLine();

                int parzyste = IleParzystych(aktualnyZestaw);

                Console.WriteLine($"Liczb parzystych w tym zestawie: {parzyste}");
                Console.WriteLine();
            }

            // liczenie najpopularniejszej
            ...
            Console.WriteLine($"Najczesciej losowana liczba to: {najczestszaLiczba} (wystapila {maxWystapien} razy)");
        }
    }
}